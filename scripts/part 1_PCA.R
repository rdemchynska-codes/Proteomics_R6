...
setwd("D:/Courses/2026_Genomics_Proteomics/gr6_Project/2026_Gr6_Project/to check script part 1_PCA2")
...
### зберегти матрицю для подальшого DE аналізу
saveRDS(mat, "protein_matrix_for_DE.rds")
